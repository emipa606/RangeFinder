...
public class RangeFinderSettings : ModSettings
{
    ...
    public override void ExposeData()
    {
        ...
        customColors ??= [];
        customColorMaterials = customColors.Select(Material (_) => null).ToList();
    }
    ...
    public static void DoWindowContents(Rect canvas)
    {
        ...
        var listRect = list.GetRect(canvas.height - list.CurHeight - 24 - 12 - padding);
        ...
        Widgets.BeginScrollView(listRect, ref scrollPosition, innerRect);
